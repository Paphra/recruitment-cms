...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='client',
            name='contact_mode',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='settings.contactmode'),
        ),
        migrations.AddField(
            model_name='client',
            name='job',
        ...
        migrations.AddField(
            model_name='client',
            name='publicity',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='settings.publicity'),
        ),
        migrations.AddField(
            model_name='client',
            name='user',
